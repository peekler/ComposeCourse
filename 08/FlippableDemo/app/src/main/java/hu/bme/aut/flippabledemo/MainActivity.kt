...
fun MainScreen() {
    ...
    Column(modifier = Modifier
        ...
        Button(onClick = { controller.flip() }) {
            Text(text = "Flip")
        }
        ...
        Flippable(
            modifier = Modifier
                .fillMaxWidth()
                .fillMaxHeight(0.3f),
            frontSide = { CardElement(title = "Card Front", background = MaterialTheme.colorScheme.surfaceVariant) },
            backSide = { CardElement(title = "Card Back",
